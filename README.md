...
<h1 align="center">ProLinear</h1>
 ...
 <br><br>
 <b>Etapas desenvolvidas:</b> Entrada de dados :arrow_right: Geração da população inicial :arrow_right: Cálculo da aptidão de cada indivíduo :arrow_right: Geração da descendência :arrow_right: Realiza a mutação :arrow_right: Gera a nova população após a mutação :arrow_right: Cálculo da aptidão da nova população :arrow_right: Aponta os primeiros resultados.
 <br><br>
